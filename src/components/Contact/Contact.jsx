        ...
        <div className="mt-8 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <form
              ...
              action="https://formspree.io/f/mzzpqyrz"
              method="POST"
            >
              ...
              <div className="mt-2 flex flex-col">
                <input
                  ...
                  className="w-100 mt-2 h-24 rounded-lg border border-gray-400 bg-white px-3 py-3 font-semibold text-gray-800 focus:border-orange-500 focus:outline-none"
                />
              </div>
